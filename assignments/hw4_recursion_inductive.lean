...
| zero _ := zero
| (succ n') m := add_mnat (mult_mnat n' m) m
...
| zero := succ zero
| (succ zero) := succ zero
| (succ n') := mult_mnat (fac_mnat n' ) (succ n')
-- Your code here
...
the one-smaller list, t, as its "tail"). 
-/
...
#reduce is_empty one_two_three 
#reduce is_empty empty_list
/-
#2C. [10 points]
...
def prepend_mnat : mnat → list_mnat → list_mnat:=
    λ n: mnat, λ h: list_mnat , cons n h

#reduce prepend_mnat mzero one_two_three 
/-
#2D. [10 points]
...
#reduce tail_mnat one_two_three   
#reduce tail_mnat empty_list
/-
#2E. [10 points]
...
| nil := mzero
| (cons h t) := add_mnat mone (length_mnat t)

#reduce length_mnat one_two_three
#reduce length_mnat empty_list
/-
2F. [Extra Credit]
...
| (cons h t) nil := cons h t
| (cons h t) (cons h' t') := cons h (append_mnat t (cons h' t'))
/-
...
#reduce append_mnat empty_list three_four
#reduce append_mnat three_four empty_list
#reduce append_mnat empty_list empty_list
